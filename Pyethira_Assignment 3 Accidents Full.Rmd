---
title: "Assignment 3 Accidents Full"
...
We want to guess if a recent accident led to someone getting hurt. If MAX_SEV_IR shows 1 or 2, it means someone was injured. If it's 0, no one got hurt. Let's make a new label called INJURY. It'll say "yes" when there's an injury and "no" when there isn't.

```{r}
#Load the complete accidents dataset and set up or bring in any necessary libraries.
...
```{r}
Accidents_Data<- read.csv("C:/Users/drpra/Downloads/accidentsFull.csv")
...
#Create and add a dummy variable “INJURY” in the data.
...
```{r}
#Construct a table based on the "INJURY" data.
...
```{r}
#creating a new subset with only the required records
...
Accidents_Data24$nbpred.prob <- NBT[,2] 
#Transfer the "Yes" nb prediction
library(caret)
